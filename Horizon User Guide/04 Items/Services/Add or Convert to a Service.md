...
2. **Access Item Management**:
    ...
    - Click **Item Management**, then choose **Services**.
...
5. **Verify the New Service**:
    ...
    5.2. Switch to **Find Mode**, type the service name, and press **Return** (Mac) or **Enter** (Windows). Verify that the new service appears in the search results.
...
<img src="https://github.com/Fx-Professional-Services/HorizonDocs/blob/staging/Horizon%20User%20Guide/00%20Assets/70_role_job_title_service_subtypes.png" width="350" height="250"> 

6. **Verify Conversion**
    
6.1. Return to **Item Management** and select **All Items**.

<img src="https://github.com/Fx-Professional-Services/HorizonDocs/blob/staging/Horizon%20User%20Guide/00%20Assets/72_all_items.png" width="350" height="230"> 
...
<img src="https://github.com/Fx-Professional-Services/HorizonDocs/blob/staging/Horizon%20User%20Guide/00%20Assets/71_verify_conversion.png" width="350" height="230"> 
