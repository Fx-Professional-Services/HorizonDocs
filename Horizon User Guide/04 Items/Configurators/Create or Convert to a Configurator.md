...
3. **Select an Existing Item:**
    ...
    - In the picker, locate the item by scrolling or using the search icon (🔎). Click the **Add** button (✚) next to the item to automatically select it and close the window.
