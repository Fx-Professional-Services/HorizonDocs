...
- **Source**: Select the lead’s source (e.g., referral, website, social media).
...
- **Done:** This field will be updated to **Yes** automatically once the lead has been linked to an opportunity. If the opportunity is removed or unlinked, the **Done** field will be cleared (set to empty).
...
2. **Initiate a New Lead Record**
    
    - Click **New Record** in the Leads layout.
3.  **Enter Lead Details**
	- Fill in the following information:

5. **Delete a Lead Record** (if needed) 

 ⚠️ **Note**:  To delete a lead record, click **Delete Record** in the secondary navigation buttons at the top. 
...
Follow these steps to create an opportunity:
...
2. **Open the Opportunities Module**
    ...
    - In the **Leads** module, click on **Opportunities**.
3. **Select or Create an Opportunity**
    
    - Select an existing opportunity from the list, or click the **Add (+)** button to create a new opportunity.
4. **Enter Opportunity Details**
    
   - Fill in the following fields:
        - **Event Date**: The date associated with the opportunity.
        - **Probability**: The likelihood of closing the opportunity, typically represented as a percentage.
