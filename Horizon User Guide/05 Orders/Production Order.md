...
* In the Production Order under the **Order** tab, assign an employee responsible for the order by clicking **Click here to select employee**.

9. **Enter Production Dates** 
...
13. **Access Additional Settings:**

* Tap the gear icon to access additional settings and  the i icon for more information.

14. **Delete or Modify Line Items**
