...
- Select a Receiving Order record from the left pane.

- Click **Delete Record** to delete a specific receiving order record.

⚠️ **Note**: Only unconfirmed receiving orders can be deleted. Confirm deletion by clicking **Yes** in the dialog box.
