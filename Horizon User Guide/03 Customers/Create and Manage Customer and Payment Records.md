...
9. **Unconfirm Payment**: You cannot revert confirmed Card or ACH payments. However, you can unconfirm Check payments and modify the details. Click **Unconfirm** to revert the confirmation.
