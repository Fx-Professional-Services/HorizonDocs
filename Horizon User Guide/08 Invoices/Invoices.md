...
### Steps to Manage a Sales Invoice

#### 1. Access the Invoices Module

- From the main menu, click **Invoices** to open the invoice management interface.
    

#### 2. Find the Invoice

- Use **Find Mode** to search for a specific invoice.
