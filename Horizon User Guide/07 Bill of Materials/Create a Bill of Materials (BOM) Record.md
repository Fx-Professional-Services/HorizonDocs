...
- **Add New Item**: Click the **Add** button (✚) in the top right corner of the picker window. Enter the product details (name, description, replenishment method, etc.), then click **Save**.
